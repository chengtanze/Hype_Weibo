...
- (void)viewDidLoad {
    ...
    self.Weibo_Home_TableView.rowHeight = 80;
...
{
    [tableView registerNib:[UINib nibWithNibName:@"Weibo_Home_TableViewCell" bundle:nil] forCellReuseIdentifier:@"Weibo_Home_Cell"];
    Weibo_Home_TableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"Weibo_Home_Cell"];
    
    //这个方法加载不能实现 回收机制
//    Weibo_Home_TableViewCell *cell = [[[NSBundle mainBundle] loadNibNamed:@"Weibo_Home_TableViewCell" owner:self options:nil] objectAtIndex:0];
